...
class CustomAccountManager(BaseUserManager):
    ...
    def create_superuser(self, email, rank, surname, password, **other_fields):
        ...
        return self.create_user(email, rank, surname, password, **other_fields)

    def create_user(self, email, rank, surname, password, **other_fields):
